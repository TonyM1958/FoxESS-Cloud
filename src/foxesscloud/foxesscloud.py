...
def set_period(start=None, end=None, mode=None, min_soc=None, max_soc=None, fdsoc=None, fdpwr=None, price=None, segment=None, quiet=1):
    ...
    fdpwr = power if fdpwr is None and power is not None and ('ForceCharge' in mode or 'ForceDischarge' in mode) else fdpwr
...
def charge_needed(forecast=None, consumption=None, update_settings=0, timed_mode=None, show_data=None, show_plot=None, run_after=None, reload=2,
    ...
    for i in range(0, len(work_mode_timed)):
        ...
        if timed_mode > 0 and 'ForceCharge' in work_mode:
